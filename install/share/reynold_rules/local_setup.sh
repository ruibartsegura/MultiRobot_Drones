...
: ${AMENT_CURRENT_PREFIX:="/root/CrazySim/ros2_ws/src/MultiRobot_Drones/install"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/reynold_rules/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/reynold_rules/environment/path.sh"
